...
.constant('laConfig', {
    'backend' : 'https://saesa.multinetlabs.com/api/',
    'debug' : true
})
...
/** LA CONFIG PO LOCOH **/
  //login
.config(function($stateProvider, $urlRouterProvider, $cordovaInAppBrowserProvider, $compileProvider, $ionicConfigProvider){
